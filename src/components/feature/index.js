...
import Laptop from './feature-img.png';
import './style.css';
                ...
                <div className="row min-vh-100">
                    <div className="col-md-6 col-sm-12 my-auto">
                        <div className="landing-content text-center animate__animated animate__fadeInLeft">
                            ...
                            <a className="btn btn-outline-dark rounded-sm text-uppercase px-4 py-2 animate__animated animate__bounceInLeft
                                animate__delay-1s" href="#portfolio"
                                role="button">view work
                            </a>
                        </div>
                    </div>
